...
You can customize how math is being treated on export by adapting your [YAML frontmatter](../syntax/yaml-frontmatter.md) or [profiles](../export/defaults-files.md).
