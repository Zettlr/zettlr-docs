...
## Ensuring Pandoc Compatibility

Pandoc needs to insert quite a few commands and logic to ensure that a template works as intended with Pandoc. To enable Pandoc compatibility with your template, you just need to insert one line of code, which will direct Pandoc to insert its own, common definitions and directives into your template:
