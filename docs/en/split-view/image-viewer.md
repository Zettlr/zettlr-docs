...
![image_viewer_example.png](../img/image_viewer_example.png)
...
Finally, the image viewer is just that: a viewer. If you need to edit the image, please use an external image editor for that.
