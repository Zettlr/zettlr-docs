...
To improve a translation, head over to the [`static/lang`](https://github.com/Zettlr/Zettlr/tree/develop/static/lang)-folder and download the `*.po`-file that corresponds to the language code you want to improve (e.g., `pt-BR.po` for Brazilian Portuguese).
...
3. Move into the directory:
   ...
   cd Zettlr
   ```
4. Run the initialization command, replacing `<lang>` with the corresponding language code, e.g., “pt-BR” or “de-DE”:
   ```bash
   msginit --input=static/i18n.pot --locale=<lang> --output=static/lang/<lang>.po
   ```
